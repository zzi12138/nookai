...
必须生成恰好 6 题，按以下顺序。每题的类型决定了它是”封闭题”还是”开放题”：

q1 日常用途【封闭题·可多选】
- 选项必须穷尽该房间类型的常见用途
- 卧室：睡觉休息 / 工作学习 / 追剧放松 / 化妆打扮 / 收纳储物
- 客厅：看电视 / 会客聊天 / 吃饭 / 工作 / 带娃
- 只列跟这个房间类型相关的，不要列不可能的用途
- allowMultiple: true

q2 最大痛点【封闭题·可多选】
- 选项必须是图中能看到的具体问题
- 比如：”只有一盏顶灯，没层次” / “桌面太乱” / “配色不协调” / “空间显得挤”
- 不要写”缺少美感”这种空话，要指向图中可见的问题
- 选项要尽量覆盖：灯光、收纳/整洁、配色、空间感 这几个维度
- allowMultiple: true

q3 重点区域【封闭题·单选】
- 选项是图中可见的具体区域，比如”床头和床周围” / “书桌区域” / “窗边” / “整面墙”
- allowMultiple: false

q4 想要的感觉【开放题】
- 这题不需要选项！设置 options 为空数组 []
- 用户会在自由输入框里写自己想要的感觉
- question 写成引导性的，比如”改完之后你希望房间给你什么感觉？随便说说就行”
- allowMultiple: false

q5 改动程度【封闭题·单选】
- 必须恰好 3 个选项，从小到大，每个说明具体意味着什么变化
- 比如：”小改，加点灯和抱枕” / “中改，换床品加地毯加灯” / “大改，软装全部重新搭配”
- allowMultiple: false

q6 不想要的【开放题】
- 这题不需要选项！设置 options 为空数组 []
- 用户会自由输入不想要的东西
- question 写成具体的引导，比如”图里有什么你特别不想保留的吗？比如某个颜色、某个物件”
- allowMultiple: false

每题格式：
- 封闭题：options 数组 3-6 个选项，最后一个固定为 {“value”:”ai_decide”,”label”:”你来决定”,”desc”:”交给 AI 自动判断”}
- 开放题：options 设为空数组 []，不要加 ai_decide
- 每个 option 必须有 value, label, desc 三个字段
- label 2-8个中文字，desc 4-12个中文字
- 禁止文艺比喻！
