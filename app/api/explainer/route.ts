...
任务：仔细观察【效果图 AFTER】，${hasBefore ? '对比【原图 BEFORE】，只列出效果图中新添置的软装；原图中已有的大型固定家具（床架/衣柜/沙发本身）无需列出。' : '不要列出建筑结构（墙/地板/天花板）或大型固定家具本身（床架/衣柜/沙发主体）。'}
...
2. 逐类检查，不要遗漏：
   ...
   - 绿植：大叶植物、小盆栽（如有多棵小盆栽，一起列出）、多肉、花束
   - 墙面装饰：挂画、海报、装饰镜
   - 摆件：花瓶、小雕塑、托盘——逐一列出
